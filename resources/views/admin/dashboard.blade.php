                    ...
                    <ul class="list-group list-group-flush">
                        @forelse ($upcomingEvents as $event)
                            <li class="list-group-item d-flex justify-content-between align-items-center hover-bg-light">
                                ...
                                <a href="{{ route('events.detail', $event->event_id) }}" class="btn btn-outline-success btn-sm rounded-pill">Ver Detalle</a>
                            </li>
                        @empty
            ...
            <div class="col-lg-4">
                <div class="card shadow-sm border-0" style="border-radius: 1rem;">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('events.create') }}" class="list-group-item list-group-item-action py-3 d-flex align-items-center">
